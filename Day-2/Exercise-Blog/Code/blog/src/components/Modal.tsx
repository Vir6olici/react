...
interface ModalProps {
    tempArticle: ArticleModel;
    setTempArticle: Dispatch<SetStateAction<ArticleModel>>;
    isModalOpen: boolean;
...
function Modal(props: ModalProps) {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        setTempArticle((prevState: ArticleModel) => ({
            ...prevState,
            [name]: value
        }));
    };

    const saveOrUpdateArticle = (tempArticle: ArticleModel) => {
